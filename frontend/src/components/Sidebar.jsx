...
export const COMPANIES = [
  { id: 'abb', name: 'ABB India Ltd.', symbol: 'ABB.NS', icon: '⚡', color: 'bg-red-600', logo: 'https://logo.clearbit.com/abb.com' },
  { id: 'adaniensol', name: 'Adani Energy Solutions Ltd.', symbol: 'ADANIENSOL.NS', icon: '🔋', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/adani.com' },
  ...
  { id: 'adaniports', name: 'Adani Ports and Special Economic Zone Ltd.', symbol: 'ADANIPORTS.NS', icon: '⚓', color: 'bg-blue-700', logo: 'https://logo.clearbit.com/adaniports.com' },
  ...
  { id: 'apollohosp', name: 'Apollo Hospitals Enterprise Ltd.', symbol: 'APOLLOHOSP.NS', icon: '🏥', color: 'bg-red-500', logo: 'https://logo.clearbit.com/apollohospitals.com' },
  { id: 'asianpaint', name: 'Asian Paints Ltd.', icon: '🎨', color: 'bg-red-600', logo: 'https://logo.clearbit.com/asianpaints.com' },
  { id: 'dmart', name: 'Avenue Supermarts Ltd.', symbol: 'DMART.NS', icon: '🛒', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/dmartindia.com' },
  ...
  { id: 'bajfinance', name: 'Bajaj Finance Ltd.', symbol: 'BAJFINANCE.NS', icon: '💰', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/bajajfinserv.in' },
  { id: 'bajajfinsv', name: 'Bajaj Finserv Ltd.', icon: '💼', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/bajajfinserv.in' },
  { id: 'bajajhldng', name: 'Bajaj Holdings & Investment Ltd.', symbol: 'BAJAJHLDNG.NS', icon: '🏢', color: 'bg-blue-700', logo: 'https://logo.clearbit.com/bajajholdings.in' },
  ...
  { id: 'bpcl', name: 'Bharat Petroleum Corporation Ltd.', symbol: 'BPCL.NS', icon: '⛽', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/bharatpetroleum.in' },
  ...
  { id: 'cgpower', name: 'CG Power and Industrial Solutions Ltd.', symbol: 'CGPOWER.NS', icon: '⚡', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/cgpower.com' },
  { id: 'canbk', name: 'Canara Bank', icon: '🏦', color: 'bg-orange-600', logo: 'https://logo.clearbit.com/canarabank.com' },
  { id: 'cholafin', name: 'Cholamandalam Investment and Finance Company Ltd.', symbol: 'CHOLAFIN.NS', icon: '💰', color: 'bg-red-600', logo: 'https://logo.clearbit.com/cholamandalam.com' },
  ...
  { id: 'drreddy', name: "Dr. Reddy's Laboratories Ltd.", symbol: 'DRREDDY.NS', icon: '💊', color: 'bg-red-600', logo: 'https://logo.clearbit.com/drreddys.com' },
  { id: 'eichermot', name: 'Eicher Motors Ltd.', icon: '🏍️', color: 'bg-red-700', logo: 'https://logo.clearbit.com/eichermotors.com' },
  { id: 'eternal', name: 'Eternal Ltd.', symbol: 'ZOMATO.NS', icon: '🏢', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/eternalgroup.in' },
  ...
  { id: 'hdfclife', name: 'HDFC Life Insurance Company Ltd.', symbol: 'HDFCLIFE.NS', icon: '🛡️', color: 'bg-red-600', logo: 'https://logo.clearbit.com/hdfclife.com' },
  ...
  { id: 'icicigi', name: 'ICICI Lombard General Insurance Company Ltd.', symbol: 'ICICIGI.NS', icon: '🛡️', color: 'bg-orange-600', logo: 'https://logo.clearbit.com/icicilombard.com' },
  ...
  { id: 'irfc', name: 'Indian Railway Finance Corporation Ltd.', symbol: 'IRFC.NS', icon: '🚂', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/irfc.co.in' },
  { id: 'naukri', name: 'Info Edge (India) Ltd.', icon: '💼', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/naukri.com' },
  { id: 'infy', name: 'Infosys Ltd.', symbol: 'INFY.NS', icon: '💻', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/infosys.com' },
  ...
  { id: 'jindalstel', name: 'Jindal Steel Ltd.', symbol: 'JINDALSTEL.NS', icon: '🏭', color: 'bg-red-600', logo: 'https://logo.clearbit.com/jindalsteelpower.com' },
  { id: 'jiofin', name: 'Jio Financial Services Ltd.', symbol: 'JIOFIN.NS', icon: '💰', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/jio.com' },
  { id: 'kotakbank', name: 'Kotak Mahindra Bank Ltd.', icon: '🏦', color: 'bg-red-700', logo: 'https://logo.clearbit.com/kotak.com' },
  { id: 'ltim', name: 'LTIMindtree Ltd.', symbol: 'LTIM.NS', icon: '💻', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/ltimindtree.com' },
  ...
  { id: 'lodha', name: 'Lodha Developers Ltd.', symbol: 'LODHA.NS', icon: '🏗️', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/lodhagroup.in' },
  ...
  { id: 'maxhealth', name: 'Max Healthcare Institute Ltd.', symbol: 'MAXHEALTH.NS', icon: '🏥', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/maxhealthcare.in' },
  { id: 'mazdock', name: 'Mazagoan Dock Shipbuilders Ltd.', symbol: 'MAZDOCK.NS', icon: '🚢', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/mazagondock.in' },
  ...
  { id: 'ongc', name: 'Oil & Natural Gas Corporation Ltd.', symbol: 'ONGC.NS', icon: '🛢️', color: 'bg-red-600', logo: 'https://logo.clearbit.com/ongcindia.com' },
  ...
  { id: 'powergrid', name: 'Power Grid Corporation of India Ltd.', symbol: 'POWERGRID.NS', icon: '⚡', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/powergridindia.com' },
  { id: 'pnb', name: 'Punjab National Bank', icon: '🏦', color: 'bg-blue-700', logo: 'https://logo.clearbit.com/pnbindia.in' },
  { id: 'recltd', name: 'REC Ltd.', symbol: 'RECLTD.NS', icon: '💰', color: 'bg-green-600', logo: 'https://logo.clearbit.com/recindia.nic.in' },
  { id: 'reliance', name: 'Reliance Industries Ltd.', icon: '🏭', color: 'bg-blue-700', logo: 'https://logo.clearbit.com/ril.com' },
  { id: 'sbilife', name: 'SBI Life Insurance Company Ltd.', symbol: 'SBILIFE.NS', icon: '🛡️', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/sbilife.co.in' },
  { id: 'motherson', name: 'Samvardhana Motherson International Ltd.', symbol: 'MOTHERSON.NS', icon: '🚗', color: 'bg-red-600', logo: 'https://logo.clearbit.com/motherson.com' },
  { id: 'shreecem', name: 'Shree Cement Ltd.', icon: '🏗️', color: 'bg-gray-600', logo: 'https://logo.clearbit.com/shreecement.com' },
  { id: 'shriramfin', name: 'Shriram Finance Ltd.', symbol: 'SHRIRAMFIN.NS', icon: '💰', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/shriramfinance.in' },
  ...
  { id: 'sunpharma', name: 'Sun Pharmaceutical Industries Ltd.', symbol: 'SUNPHARMA.NS', icon: '💊', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/sunpharma.com' },
  ...
  { id: 'tataconsum', name: 'Tata Consumer Products Ltd.', symbol: 'TATACONSUM.NS', icon: '☕', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/tataconsumer.com' },
  { id: 'tmpv', name: 'Tata Motors Passenger Vehicles Ltd.', symbol: 'TATAMOTORS.NS', icon: '🚗', color: 'bg-blue-700', logo: 'https://logo.clearbit.com/tatamotors.com' },
  ...
  { id: 'titan', name: 'Titan Company Ltd.', symbol: 'TITAN.NS', icon: '⌚', color: 'bg-yellow-600', logo: 'https://logo.clearbit.com/titan.co.in' },
  ...
  { id: 'vbl', name: 'Varun Beverages Ltd.', symbol: 'VBL.NS', icon: '🥤', color: 'bg-blue-600', logo: 'https://logo.clearbit.com/varunbeverages.com' },
  { id: 'vedl', name: 'Vedanta Ltd.', symbol: 'VEDL.NS', icon: '⛏️', color: 'bg-red-700', logo: 'https://logo.clearbit.com/vedantalimited.com' },
