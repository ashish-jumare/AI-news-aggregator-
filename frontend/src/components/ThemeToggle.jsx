...
export default function ThemeToggle({ newsData = [], selectedCompany, onOpenDashboard, onOpenNewsFeed, onOpenTwitterFeed, onOpenBookmarks, onOpenHelp, onOpenFeedback, onSettingsChange, onGoHome, currentView }) {
  ...
  return (
    <div className="fixed top-6 right-6 z-50 flex items-center gap-2">
      ...
      <button
        onClick={toggleTheme}
        className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 shadow-lg transition-all duration-300 transform hover:scale-110 flex items-center justify-center"
